...
def test_full_pipeline_generate_midi(mock_midi, mock_notes_service):
    # Mock the services
    mock_plan = MusicPlan(
        genre_style="Jazz",
...
@patch('src.routes.midi.notes_gen_service')
def test_pipeline_failure_at_notes(mock_notes_service):
    mock_plan = MusicPlan(
        genre_style="Jazz",
        mood_emotion="Relaxed",
        tempo_feel=TempoFeel(bpm=120, meter="4/4", feel="Swing"),
...
@patch('src.routes.midi.notes_gen_service')
def test_pipeline_failure_at_notes_empty_rhythm(mock_notes_service):
    mock_plan = MusicPlan(
        genre_style="Jazz",
        mood_emotion="Relaxed",
        tempo_feel=TempoFeel(bpm=120, meter="4/4", feel="Swing"),
